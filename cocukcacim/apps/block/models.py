...
class Block(models.Model):
    ...
    title1 = models.CharField(max_length=255, verbose_name="Başlık 1", blank=True, null=True,default="Mavi Başlık")
    title2 = models.CharField(max_length=255, verbose_name="Başlık 2", blank=True, null=True,default="Turuncu Başlık")
